...
(function () {
    ...
    p.start = function () {
        ...
        this.start_to = setTimeout(function () {
            ...
            if (that.delay > 0)
                element.style[window._jcsspfx + 'TransitionDelay'] = that.delay + 'ms';
            else
                element.style[window._jcsspfx + 'TransitionDelay'] = '';
...
(function ($) {
    ...
    p._hideTT = function () {
        ...
        this.hto = setTimeout(function () {
            ...
            that._tween = CTween.animate(that.tt, 900, that.from, {ease: 'easeOut' + that.ease, complete: function () {
...
(function ($) {
    ...
    MasterSlider.releaseDate = 'Feb 2015';
